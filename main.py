...
if __name__ == "__main__":
    ...
    parser.add_argument("--ClusterFL", type=int, default=1, help="ClusterFL")
    ...
    # scaffold
    parser.add_argument("--weight_decay", type=float, default=1e-05, help='weight decay of scaffold')
    ...
    # peravg and pFedMe
    parser.add_argument("--beta", type=float, default=0.0, help="Average moving parameter for pFedMe, or Second learning rate of Per-FedAvg")
    parser.add_argument("--personal_learning_rate", type=float, default=0.009,
