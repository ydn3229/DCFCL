...
from FLAlgorithms.additional.classify_net import S_ConvNet, Resnet_plus, Tset_ConvNet
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        if 'EMNIST-Letters' in dataset:
            ...
            self.xa_shape=[512]
            self.num_classes = 10
            self.classifier = Tset_ConvNet(28, 1, c_channel_size, xa_dim=int(np.prod(self.xa_shape)), num_classes=self.num_classes)
